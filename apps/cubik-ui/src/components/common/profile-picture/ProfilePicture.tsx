...
const ProfilePictureAvatar = (props: profilePictureProps) => {
  ...
  return (
    <Center ref={myDiv} cursor={props.asNFT ? 'pointer' : ''} position={'relative'}>
      <Avatar
        zIndex={isOpen ? 2 : 0}
                ...
                >
                  <HStack position="relative" gap="18px">
                    ...
                    <VStack
                      ...
                      align="start"
                      gap="8px"
                      bgGradient={'linear-gradient(180deg, rgba(0,0,0,0) 0%, #141414 100%)'}
                    >
                      {/* <HStack>
                      ...
                      <Skeleton isLoaded={!isLoading} opacity={0.3} fadeDuration={0.2}>
                        <Box as="p" color="neutral.11" noOfLines={1} textStyle={'title3'}>
                  ...
                  <VStack spacing="0px" py="4px">
                    <HStack w="full" p="4px 8px" justify="space-between">
                      ...
                      <Skeleton isLoaded={!isLoading} opacity={0.5} fadeDuration={0.2}>
